...
var QueuedCallInterface = function (_PlivoResourceInterfa3) {
    ...
    function QueuedCallInterface(client) {
        ...
        var _this13 = _possibleConstructorReturn(this, (QueuedCallInterface.__proto__ || Object.getPrototypeOf(QueuedCallInterface)).call(this, action, QueuedCallResource, idField, client));

        (0, _common.extend)(_this13, data);

        _this13[clientKey] = client;
        return _this13;
    }
    ...
    _createClass(QueuedCallInterface, [{
        ...
        value: function get(id) {
            ...
            return new Promise(function (resolve, reject) {
                if (action !== '' && !id) {
                    reject(new Error(_this14[idKey] + ' must be set'));
                }
