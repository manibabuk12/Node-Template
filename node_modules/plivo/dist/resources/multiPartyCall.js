  ...
  _createClass(MultiPartyCall, [{
    ...
    value: function addParticipant(params) {
      ...
      if (params.recordParticipantTrack) {
        (0, _utils.validParam)('recordParticipantTrack', params.recordParticipantTrack, [Boolean, String], false);
      } else {
  ...
  _createClass(MultiPartyCallParticipant, [{
    ...
    value: function updateParticipant() {
      ...
      if (params.disableStateChangeSound) {
        (0, _utils.validParam)('disableStateChangeSound', params.disableStateChangeSound, [Boolean, String], false);
      }
    ...
    value: function startParticipantRecording() {
      ...
      if (params.recordTrackType) {
        (0, _utils.validParam)('recordTrackType', params.recordTrackType.toUpperCase(), [String], false, ['PARTICIPANT', 'BOTH', 'ALL']);
      } else {
    ...
    value: function stopParticipantRecording() {
      ...
      params.isVoiceRequest = 'true';
      return _get(MultiPartyCallParticipant.prototype.__proto__ || Object.getPrototypeOf(MultiPartyCallParticipant.prototype), 'executeAction', this).call(this, this.id, this.secondaryId + '/Record', 'DELETE', params);
    }
  }, {
    ...
    value: function pauseParticipantRecording() {
      ...
      params.isVoiceRequest = 'true';
      return _get(MultiPartyCallParticipant.prototype.__proto__ || Object.getPrototypeOf(MultiPartyCallParticipant.prototype), 'executeAction', this).call(this, this.id, this.secondaryId + '/Record/Pause', 'POST', params);
    }
  }, {
    ...
    value: function resumeParticipantRecording() {
      ...
      params.isVoiceRequest = 'true';
      return _get(MultiPartyCallParticipant.prototype.__proto__ || Object.getPrototypeOf(MultiPartyCallParticipant.prototype), 'executeAction', this).call(this, this.id, this.secondaryId + '/Record/Resume', 'POST', params);
    }
  }]);
