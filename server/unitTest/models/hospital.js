...
function Hospital(options = {}) {var email = options.email || fake.email();
...
var hospitalName = options.hospitalName || fake.name();
this.getHospitalName = function getHospitalName() {
  return hospitalName;
};
